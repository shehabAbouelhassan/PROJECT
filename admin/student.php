                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from LMS.user where (Code='$s' or Name like '%$s%') and Code<>'ADMIN'";
                                        }
                                    else
                                        $sql="select * from LMS.user where Code<>'ADMIN'";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><?php echo $email ?></td>                                      
                                        <td>
                                        <center>
                                            <a href="studentdetails.php?id=<?php echo $Code; ?>" class="btn btn-success">Details</a>
